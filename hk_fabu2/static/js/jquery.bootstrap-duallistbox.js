;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextEmpty: '<b class="red">无待选项<b>',                                                        // when there are no options present in the list
  ...
  function refreshInfo(dualListbox) {
    ...
    if (all1 === 0) {
      ...
      content = formatString('<b class="orange">可选服务器('+dualListbox.settings.infoText+')<b>', [visible1, all1]);
    } else {
    ...
    if (all2 === 0) {
      ...
      content = formatString('<b class="green">已选服务器('+dualListbox.settings.infoText+')<b>', [visible2, all2]);
    } else {
